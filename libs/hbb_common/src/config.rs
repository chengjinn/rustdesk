...
pub const RENDEZVOUS_SERVERS: &[&str] = &["chengjinn.vicp.net"];
pub const PUBLIC_RS_PUB_KEY: &str = "B2JV3COmNpTO+bPCLbiimXeccSGYr1moLiyoJKVcuBo=";
...
pub const RENDEZVOUS_PORT: i32 = 21216;
pub const RELAY_PORT: i32 = 21217;
